...
@objc public class Chat360Config : NSObject {
    ...
    @objc private var stagingUrl = "https://staging.chat360.io/page/?h="
       ...
       @objc private var customBaseUrl: String? = nil   // <--- new property
       ...
       /// Allows SDK user to override base URL
       @objc public func setBaseUrl(with url: String) {
       ...
       @objc private func createBaseUrl(with metaString: String?) -> URL? {
           ...
           let base = customBaseUrl ?? (isDebug ? stagingUrl : baseUrl)
