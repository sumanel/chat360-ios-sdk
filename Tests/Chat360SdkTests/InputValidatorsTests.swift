...
final class InputValidatorsTests: XCTestCase {
    func testValidateEmailAcceptsWellFormedAndRejectsMalformed() {
    ...
    func testValidateTestFlagsLiteralWordTest() {
    ...
    func testValidateTestNameFlagsStandaloneWordTest() {
    ...
    func testValidatePhoneNumberRejectsRepeatedDigit() {
