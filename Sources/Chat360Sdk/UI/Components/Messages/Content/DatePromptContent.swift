...
/// A button opening a calendar, submitting the pick immediately. SwiftUI's `DatePicker` has no
/// per-day enable/disable hook, so disabled dates are enforced on confirm instead of grayed out
